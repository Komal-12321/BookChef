...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1"><b>Search Bookings</b></h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Enter Following Details :</h4>
						</div>
						<div class="form-body">
							<form action="Search_Bookings.jsp" > 
								
								<div class="form-group"> 
									<br><label for="bdate"><h4>Enter Date</h4></label><br><br>
									<input type="date" name="bdate" class="form-control" id="exampleInputEmail1" placeholder="Your City"> <br>
							</div>	 
...
<div class="table-container">
 <table class="table table-hover">		
	...
	{					int cid=PojoUser.getCid();
						String Key1=request.getParameter("bdate");
