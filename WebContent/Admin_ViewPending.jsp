...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><b>Pending Chefs</b></h3>
    ...
    <table class="table table-hover">
						...
						try
						{
								...
								{%>
									...
									<td><a href="ChefApproved.jsp?id=<%=rs.getInt(1) %>"> <input type="submit" value="Approve"><br><br> </a></td>
									<td><a href="ChefDisapproved.jsp?id=<%=rs.getInt(1) %>"><input type="submit" value="Disapprove"></a></td>
