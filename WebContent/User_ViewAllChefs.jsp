...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1"><b>View Chef</b></h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Enter Following Details :</h4>
						</div>
						<div class="form-body">
							<form action="User_ViewAllChefs.jsp" > 
								
								<div class="form-group"> 
									<br><label for="ccity"><h4>Enter City</h4></label><br><br>
									<input type="text" name="ccity" class="form-control" id="exampleInputEmail1" placeholder="Your City"> <br>
							</div>	 
 ...
 <table class="table table-hover">		
	...
	<%
							Connection con=ConnectDB.dbCon();
								PreparedStatement ps=con.prepareStatement("select * from chef where ccity=? and cstatus=?");
								ps.setString(1, Key1);
