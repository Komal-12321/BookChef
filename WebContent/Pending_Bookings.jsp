		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					...
					<h3 class="title1"><b>Pending Bookings</b></h3>
    ...
    <table class="table table-hover">
						...
						try
						{
							int cid=PojoUser.getCid();
								...
								PreparedStatement ps=con.prepareStatement("select * from bookings where bstatus=? and cid=?");
								...
								while(rs.next())
								{
									...
									<td><a href="Booking_approved.jsp?id=<%=rs.getInt(1) %>"> <input type="submit" value="Approve"><br><br> </a></td>
									<td><a href="Booking_disapproved.jsp?id=<%=rs.getInt(1) %>"><input type="submit" value="Disapprove"></a></td>
